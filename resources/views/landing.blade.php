<x-front-layout>
    ...
    <!-- FAQ -->
    <section class="container relative py-[100px]" id="FAQ">
        ...
        <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]"
          ...
          <div class="hidden pt-4 max-w-[335px]" id="faq1-content">
            <p class="text-base text-dark leading-[26px]">
              Persyaratan untuk menyewa mobil biasanya meliputi:
              KTP, SIM, Usia Min 21 tahun, Bukti Pembayaran
            </p>
          </div>
        </a>
        <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]"
          ...
          <div class="flex items-center justify-between gap-1">
            <p class="text-base font-semibold text-dark">
              Apa jenis mobil yang tersedia untuk disewa?
            </p>
            <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
          </div>
          <div class="hidden pt-4 max-w-[335px]" id="faq2-content">
            <p class="text-base text-dark leading-[26px]">
              Ada 4 jenis mobil yang tersedia untuk disewa,
              termasuk Honda Brio, Toyota Avanza, Expander, Toyota Innova dengan interior mewah.
              Anda dapat memilih mobil yang sesuai dengan kebutuhan dan anggaran Anda.
            </p>
          </div>
        </a>
        <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]"
          ...
          <div class="flex items-center justify-between gap-1">
            <p class="text-base font-semibold text-dark">
              Berapa biaya sewa mobil?
            </p>
            <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
          </div>
          <div class="hidden pt-4 max-w-[335px]" id="faq3-content">
            <p class="text-base text-dark leading-[26px]">
              Biaya sewa mobil bervariasi tergantung pada jenis mobil dan durasi sewa.
              Anda dapat mencari tahu biaya sewa dengan mengunjungi catalog pada website ini.
            </p>
          </div>
        </a>
        <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]"
          ...
          <div class="flex items-center justify-between gap-1">
            <p class="text-base font-semibold text-dark">
              Apa saja biaya tambahan yang harus saya perhatikan saat menyewa mobil?
            </p>
            <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
          </div>
          <div class="hidden pt-4 max-w-[335px]" id="faq4-content">
            <p class="text-base text-dark leading-[26px]">
              Biaya tambahan yang harus Anda perhatikan saat menyewa mobil meliputi:
              Biaya asuransi, Biaya bensin, Biaya parkir, Biaya tol,
              Biaya penalti untuk pengembalian mobil yang terlambat
            </p>
          </div>
        </a>
        <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]"
          ...
          <div class="flex items-center justify-between gap-1">
            <p class="text-base font-semibold text-dark">
              Bagaimana cara saya memesan mobil rental?
            </p>
            <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
          </div>
          <div class="hidden pt-4 max-w-[335px]" id="faq5-content">
            <p class="text-base text-dark leading-[26px]">
              Anda dapat memesan mobil rental secara online, 
              melalui telepon, atau langsung di kantor perusahaan rental mobil.
              Saat memesan, Anda perlu memberikan informasi seperti nama, alamat, nomor telepon, tanggal dan waktu pengambilan dan pengembalian mobil, serta jenis mobil yang Anda inginkan.
            </p>
          </div>
        </a>
        <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]"
          ...
          <div class="flex items-center justify-between gap-1">
            <p class="text-base font-semibold text-dark">
              Apa yang harus saya lakukan jika saya mengalami kecelakaan saat menyewa mobil?
            </p>
            <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
          </div>
          <div class="hidden pt-4 max-w-[335px]" id="faq6-content">
            <p class="text-base text-dark leading-[26px]">
              Jika Anda mengalami kecelakaan saat menyewa mobil, 
              Anda harus segera melaporkannya ke perusahaan rental mobil.
              Anda juga harus menghubungi polisi dan membuat laporan polisi.
              Perusahaan rental mobil akan membantu Anda menangani klaim asuransi.
            </p>
          </div>
        </a>
      </div>
    ...
    <footer class="py-10 md:pt-[100px] md:pb-[70px] container">
      <p class="text-base text-center text-secondary">
        All Rights Reserved. Copyright Mohammad Aizad Project 2023.
      </p>
    </footer>
  </x-front-layout>
